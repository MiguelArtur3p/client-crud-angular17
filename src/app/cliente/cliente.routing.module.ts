...
import { clientResolver } from './services/cliente-resolver';
...
const routes: Routes = [
    ...
    { path: 'detalhes/:id', component: ClienteFormComponent, resolve: { cliente: clientResolver }, data: { operacao: 'detalhes', rota: 'cliente' }, canActivate: [permissionsGuard] },
